...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var GLASS_CSS = [
      ...
      // whenever no wallpaper is set or after it is removed.
    ...
    function apply(ctx) {
      ...
      try { writeThemeColor(); themeColorHandle = startThemeColorWatch() } catch (e) { console.warn('[dsh-glass] theme-color watch failed', e) }
      ctx.effect(function () {
        return function () {
          var tag = document.getElementById(STYLE_ID)
          if (tag) tag.remove()
